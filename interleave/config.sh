...
# Number of weight points in the CXL-Interleave sweep.
# Sweep covers ratios (P-1):1, (P-2):2, ... 1:(P-1)  ->  (P-1) runs per workload.
# Override per invocation: INTERLEAVE_PARTITIONS=5 bash run.sh w.txt
INTERLEAVE_PARTITIONS=${INTERLEAVE_PARTITIONS:-10}
