...
datasets=("randomSeq_100M_256_int" "randomSeq_100M_100K_int" "randomSeq_100M_int" "exptSeq_100M_int" "almostEqualSeq_100000000")
...
if [[ $tag == "L100" ]]; then
	...
	for i in "${datasets[@]}"
	do
		numactl -i 0,1 ${VMTOUCH} -f -t ${DATA_DIR}/${i}
	done
fi
